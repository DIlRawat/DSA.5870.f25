...
\def\problemText{
Given the following graph, use Prim's algorithm to construct a minimum-cost
spanning tree. Indicate the order in which vertices are selected, and the cost
of each selected vertex. After each selection / update, show the cost and parent
of each unselected vertex.
...
\textcolor{blue}{
\textbf{Answer:}\\
This is what the answer should look like. Note that this is part of a
correct answer.
\\[6pt]
